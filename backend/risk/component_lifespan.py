...
_COMPONENTS = [
    ...
    },
    {
        "name": "Foundation",
        "lifespan": (50, 100),
        "replacement_cost": "$5,000–$100,000",
        "priority": "High",
        "why": "Foundation issues are among the most serious and expensive defects; they affect structural integrity and insurability",
        "keywords_updated": [
            "foundation repaired", "foundation fixed", "new foundation", "foundation work",
            "underpinned", "foundation replaced", "foundation stabilized", "foundation reinforced",
        ],
        "missing_label": "Foundation type, condition, and recent inspection",
        "question": "Has the foundation been professionally inspected recently? Are there any visible cracks, settlement, or drainage issues?",
    },
    {
        "name": "Plumbing",
        "lifespan": (40, 70),
